...
read = "/projects/bgmp/ahowells/multiplexing/R4_test_file.fastq.gz"
...
#initialize an array 
read_array = np.zeros((101),dtype=float)
read_array[0]
    ...
    for line in fh: 
        ...
        if LN % 4 == 3: 
            ...
            for letter in line:
                ...
                read_array[index] += qscore 
                index +=1
        LN +=1
            

mean = np.zeros(((101)), dtype=float)
mean = read_array/(LN/4)
#print(mean)
...
plt.savefig('Read2_qualityscores')
